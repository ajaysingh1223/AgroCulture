            ...
            <div class="inner">
                ...
                <form method="post" action="Profile/updateProfile.php">
                    <div class="row uniform">
                      ...
                      <input type="text" name="mobile" id="mobile" value="<?php echo isset($_SESSION['MobileNo']) ? $_SESSION['MobileNo'] : '';?>" placeholder="Mobile No" required/>
                      <?php if(isset($errors['mobile'])) echo '<p class="error">' . $errors['mobile'] . '</p>'; ?>
                        ...
                        <div class="6u 12u$(xsmall)">
                            ...
                            <option value="<?php echo isset($_SESSION['Section']) ? $_SESSION['Section'] : ''; ?>"><?php echo isset($_SESSION['Section']) ? $_SESSION['Section'] : 'Select section'; ?></option>
                      ...
                      <option value="Decoration">Decoration</option>
                       <option value="Other">Other</option>
                        ...
                        <div class="6u 12u$(xsmall)">
                        <input type="text" name="post" id="post" value="<?php echo isset($_SESSION['Post']) ? $_SESSION['Post'] : ''; ?>" placeholder="Post Name" required/>
                       </div>
